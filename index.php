...
<head>
    ...
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/images/resources/logo.webp" />
    <link rel="icon" type="image/png" sizes="32x32" href="assets/images/resources/logo.webp" />
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/resources/logo.webp" />
    ...
    <!-- <link
    rel="preconnect" href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,wght@0,400;0,500;0,700;1,400;1,500;1,700&amp;display=swap"
        rel="stylesheet"> -->
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                             <div class="site-footer__bottom-inner">
                                ...
                                </p> <p class="site-footer__bottom-text" style="text-align:end">Designed By <a href="https://tectignis.in" target="_blank"><b>Tectignis IT Solutions.</b></a></p>
                            </div>
                        </div>
                    </div>
                </div>
